...
const Loading  = () => {
    ...
    return (
        <div style={{minHeight: '100vh', alignContent: 'center', textAlign: 'center'}}>
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" width="130" height="60" viewBox="0 0 130 60" xmlSpace="preserve" style={{fill:'white', width: 260, height: 120, marginTop: 'calc(50vh - 100px)'}}>
                <desc>Created with Fabric.js 4.6.0</desc>
                <defs>
                </defs>
                <g transform="matrix(0.13 0 0 -0.13 65.89 30.79)" id="uzIOWGqMEI6WpHsfhOhFi"  >
                <path 
                    style={{stroke: 'none', strokeWidth: 1, strokeDasharray: 'none', strokeLinecap: 'butt', strokeDashoffset: 0, strokeLinejoin: 'miter', strokeMiterlimit: 4, fill: 'rgb(255,255,255s)', fillRule: 'nonzero', opacity: 1}}
