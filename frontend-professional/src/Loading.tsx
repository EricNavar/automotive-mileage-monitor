        ...
        <div style={{minHeight: '100vh', alignContent: 'center', textAlign: 'center'}}>
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" width="130" height="60" viewBox="0 0 130 60" xmlSpace="preserve" style={{fill:'#000', width: 260, height: 120, marginTop: 'calc(50vh - 100px)'}}>
                ...
                <path 
                    ...
                    vectorEffect="non-scaling-stroke"  transform=" translate(-500, -690)"
            ...
            <br/>
            <div style={{marginLeft: 10, marginTop: -25}} className="lds-ring"><div></div><div></div><div></div><div></div></div>
            <div style={{marginLeft: 100, marginTop: -25}} className="lds-ring"><div></div><div></div><div></div><div></div></div>
            <p>Making lots of calculations...</p>
        </div>
    );
};
